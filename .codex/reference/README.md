# Finlight Original Site References

These files preserve the original source material used to recreate the Finlight Consulting site.
...
Before changing layout, typography, animation, section backgrounds, article text, or navigation, inspect the relevant screenshot and/or HTML dump here first.

The HTML files are intentionally raw dumps. Do not edit them unless refreshing the original source references.
